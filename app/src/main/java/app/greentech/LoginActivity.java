...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gLoginButton = (SignInButton) findViewById(R.id.btn_google_login);
        gLoginButton.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void getUsername() {
        if (mEmail == null) {
            ...
            if (isDeviceOnline()) {
                new GetGUsernameTask(LoginActivity.this, mEmail, SCOPE).execute();
            } else {
